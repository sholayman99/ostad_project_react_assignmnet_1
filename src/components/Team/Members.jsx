    ...
    return (
        <main className="bg-base-100 lg:px-20 px-6 py-10 lg:py-16 flex flex-col gap-10">
            <section className="lg:w-[40%] w-[70%]">
             <h2 className="text-[#20B15A] text-[20px] font-medium ">Our Team Member</h2>
             <h1 className="lg:text-[30px] font-bold text-[24px] text-[#000] ">Check our awesome team members</h1>
            </section>
